# Vivado build of vc707_bram36x9 -- the reference.  Every shape must pass
...
read_verilog [list $here/bram36x9.v $here/vc707_bram36x9.v \
    $repo/fpga/eth-rtl/simpleuart.v]
read_verilog -sv $repo/fpga/eth-rtl/clkgen_vc707.sv
read_xdc $here/vc707_bramtest.xdc
synth_design -top vc707_bram36x9 -part $part -include_dirs [list $here]
opt_design
place_design
route_design
...
write_bitstream -force out/vc707_bram36x9.bit
