...
# first.  vc707_bramtest_open.xdc is the constraints for this flow: the same
...
WORK=${WORK:-$HOME/bytecode-work/bramtest-open}
OUT=${OUT:-$WORK/vc707_bramtest.bit}
...
echo "== nextpnr"
"$NEXTPNR" --device "$PART" -o xdc="$HERE/vc707_bramtest_open.xdc" \
